...
public class MySplashScreenView implements SudoMain.ISplashScreenView {
    ...
    public MySplashScreenView(final Stage splashScreenStage_) {
    ...
    private void nodesConfiguration() {
        ...
        scene = new Scene(splashscreenvbox, minDisposable * .612, minDisposable * .3);
